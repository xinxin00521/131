...
import { ChevronLeft, Search, BookOpen, Video, Scale, Headphones, PlayCircle, Star, MoreHorizontal } from 'lucide-react';
...
const MOCK_FAVORITES: RecordItem[] = [
  { id: 'f1', type: '课程', title: '高新技术企业认定与研发费用加计扣除实务', cover: 'https://picsum.photos/seed/c1/400/250', time: '2024-03-27', views: '1.2w' },
  { id: 'f2', type: '播客', title: '新公司法对企业财税的影响', cover: 'https://picsum.photos/seed/p1/400/250', time: '2024-03-26', author: '财税专家 张三' },
  { id: 'f3', type: '刊物', title: '《中国税务》2024年第3期', cover: 'https://picsum.photos/seed/k1/300/400', time: '2024-03-25' },
  { id: 'f4', type: '政策', title: '关于进一步加大增值税期末留抵退税政策实施力度的公告', cover: '', time: '2024-03-24' },
  { id: 'f5', type: '视讯', title: '3分钟看懂：金税四期下，企业如何规避税务风险？', cover: 'https://picsum.photos/seed/v1/400/250', time: '2024-03-23', views: '5.4k' },
  { id: 'f6', type: '测评', title: '2024金税四期企业应对风险自测', cover: 'https://picsum.photos/seed/a1/400/250', time: '2024-03-22' },
];

const TABS = ['全部', '课程', '播客', '刊物', '政策', '视讯', '测评'];

export const FavoritesPage: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
          ...
          >
            ...
            <div className="pt-14 pb-3 px-4 bg-white/80 backdrop-blur-md sticky top-0 z-20 shadow-sm flex flex-col gap-3">
              <div className="flex items-center justify-between relative">
                ...
                <h1 className="text-[17px] font-bold text-gray-900 absolute left-1/2 -translate-x-1/2">收藏记录</h1>
              ...
              <div className="flex overflow-x-auto no-scrollbar gap-6">
                {TABS.map(tab => (
                  ...
                  >
                    {tab}
                    {activeTab === tab && (
                      <motion.div layoutId="favTab" className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-1 bg-blue-600 rounded-t-full" />
                    )}
                  </button>
                ))}
              </div>
